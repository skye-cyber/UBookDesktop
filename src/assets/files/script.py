...
parts = [
    ...
    {"id": 1, "title": "The Central and Superuniverses",
        "range": range(1, 32), "papers": []},
    {"id": 2, "title": "The Local Universe",
        "range": range(32, 57), "papers": []},
    {"id": 3, "title": "The History Of Urantia",
        "range": range(57, 120), "papers": []},
    {"id": 4, "title": "The Life and Teachings of Jesus",
        "range": range(120, 197), "papers": []},
]
...
for paragraph in raw_data[0]['sections'][0]["paragraphs"]:
    ...
    section_number = int(
        paragraph["paragraph_number"].split(":")[1].split(".")[0])
    ...
    section = next(
        (s for s in paper["sections"] if s["section_number"] == section_number), None)
    if not section:
