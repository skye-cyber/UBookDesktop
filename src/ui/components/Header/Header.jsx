...
export const Header = ({ }) => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-16 flex items-center px-4 bg-indigo-800 dark:bg-[#00657c] dark:border-y dark:border-t-0 dark:border-b-[#006d91] backdrop-blur-lg shadow-sm dark:border-b dark:border-slate-200/60 dark:border-slate-700/60 z-50 transition-all duration-500">
            ...
            <div ref={searchContainer} id="search-container" className="relative flex-1 mx-4 md:mx-[10vw] lg:mx-[20vw] transition-all duration-500 w-full">
                <div className="relative">
                    ...
                    <button id="submit-search" title="submit-search" aria-label="submit-search" className="absolute right-12 top-1/2 transform -translate-y-1/2 h-8 w-8 flex items-center justify-center rounded-lg bg-primary-500 hover:bg-primary-600 text-white transition-colors duration-300">
                    ...
                    <span id="expand-search" className="search-expand absolute right-2 top-1/2 transform -translate-y-1/2 inline-flex items-center justify-center h-8 w-8 rounded-lg bg-transparent hover:bg-slate-200 dark:hover:bg-[#00caf7] cursor-pointer transition-colors duration-300 hover:scale-[1.05]" onClick="ShowPrevSearchModal()" title="show previous section search results" aria-label="show previous section search results group">
            ...
            <div className="flex items-center space-x-3">
                ...
                <button onClick="openSearchPref()" title="Open Search Preferences" aria-label="Open Search Preferences"
                ...
                <button id="top-theme-toggle" onClick="document.getElementById('theme-toggle').click()" className="flex items-center justify-center h-10 w-10 rounded-xl bg-primary-500 dark:bg-[#004754] hover:bg-primary-700 dark:hover:bg-[#002d34] text-slate-700 dark:text-slate-300 transition-colors duration-300">
                ...
                {/* More Options Button */}
                <button onClick={ToggleSearch} id="search-toggle" className="flex items-center justify-center h-10 w-10 rounded-xl bg-primary-500 dark:bg-[#003c47] hover:bg-primary-600 dark:hover:bg-[#002d34] text-white dark:text-slate-300 transition-colors duration-300">
                    <svg className="h-6 w-6 fill-white dark:fill-current text-white dark:text-slate-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M368 144C368 170.5 346.5 192 320 192C293.5 192 272 170.5 272 144C272 117.5 293.5 96 320 96C346.5 96 368 117.5 368 144zM272 320C272 293.5 293.5 272 320 272C346.5 272 368 293.5 368 320C368 346.5 346.5 368 320 368C293.5 368 272 346.5 272 320zM368 496C368 522.5 346.5 544 320 544C293.5 544 272 522.5 272 496C272 469.5 293.5 448 320 448C346.5 448 368 469.5 368 496z" /></svg>
                </button>

                {/* clear interface */}
                <svg onClick="clearInterface()" title="clear interface" aria-label="clear interface" className="hidden h-[38px] w-[38px] fill-primary-300 dark:fill-white cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M96 160C96 124.7 124.7 96 160 96L480 96C515.3 96 544 124.7 544 160L544 480C544 515.3 515.3 544 480 544L160 544C124.7 544 96 515.3 96 480L96 160zM160 224L160 480L288 480L288 224L160 224zM480 224L352 224L352 480L480 480L480 224z" /></svg>
                <button onClick="clearInterface()">
