        ...
        <header className="flex items-center px-4 bg-indigo-800 dark:bg-[#00657c] dark:border-y dark:border-t-0 dark:border-b-[#006d91] backdrop-blur-lg shadow-sm dark:border-b dark:border-slate-200/60 dark:border-slate-700/60 z-[40] transition-all duration-500">
            ...
            <div className="flex items-center space-x-3">
                ...
                <button
                    ...
                    onClick={() => ThemeToggle.current?.click()} className="flex items-center justify-center h-10 w-10 rounded-xl bg-primary-500 dark:bg-[#004754] hover:bg-primary-700 dark:hover:bg-[#002d34] text-slate-700 dark:text-slate-300 transition-all duration-300 focus:outline-none hover:scale-[90%] ease-in-out">
