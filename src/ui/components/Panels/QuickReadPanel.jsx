...
export const QuickReadPanel = ({ }) => {
    ...
    return (
        <div ref={panel} id="Rightpanel" className="fixed z-[41] right-0 w-[300px] h-[calc(100vh-7vh)] shadow-md transform translate-x-full xl:translate-x-0 transition-all duration-700 ease-in-out bg-gradient-to-b from-white/95 to-gray-100/95 dark:from-gray-900/95 dark:to-gray-800/95 rounded-none border-none">
