...
export const ContextMenu = ({ }) => {
    return (
        <div id="contextMenu" className="context-menu fixed bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-lg shadow-xl py-2 min-w-[220px] z-50 border border-[#f8f4e9] dark:border-gray-700 pointer-event-none transition-transform -translate-y-[5px] scale-[0.95] active:bg-opacity-100 active:scale-100 active:translate-y-0 active:pointer-events-all">
            <div className="context-menu-options">
                {/* Text Selection Options */}
                <div id="textOptions" className="hidden">
                    <div className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer" data-action="selectAll">
                    ...
                    <div className="context-item hidden flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer" data-action="search">
                    ...
                    {/* Highlight Submenu */}
                    <div className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer relative select-none" data-action="highlight">
                        ...
                        <div className="sub-context-menu absolute left-full top-0 ml-1 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-lg shadow-xl py-2 min-w-[160px] transform -translate-x-1 transition-all duration-200 dark:border border-gray-700 hidden select-none">
                ...
                {/* General Options */}
                <div id="generalOptions" className="font-mono tracking-tighter">
                    <div className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer relative font-mono select-none" data-action="fontSize">
                        ...
                        {/* Font Size Submenu */}
                        <div className="sub-context-menu hidden bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 absolute left-full top-0 ml-1 rounded-lg shadow-xl py-2 min-w-[160px] transform -translate-x-1 transition-all duration-200 border dark:border-gray-700 select-none">
                    ...
                    <div className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer relative select-none" data-action="theme">
                        ...
                        {/* Theme Submenu */}
                        <div id="ltheme" className="sub-context-menu bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 absolute left-full top-0 ml-1 rounded-lg shadow-xl py-2 min-w-[160px] transform -translate-x-1 transition-all duration-200 border dark:border-gray-700 hidden">
                    ...
                    <div className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer" data-action="notes">
                    ...
                    <div className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer" data-action="dictionary">
                    ...
                    <div className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer" data-action="print">
                        ...
                        <span className="ml-auto text-xs text-gray-200 dark:text-cyan-400">Ctrl+P</span>
                    </div>

                    <div onClick={() => ContentLoader_ins.loadBookmarks()} className="context-item flex items-center px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer" data-action="viewBookmarks">
                        <svg className="h-5 w-5 mr-3 fill-gray-400 dark:fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M192 64C156.7 64 128 92.7 128 128L128 544C128 555.5 134.2 566.2 144.2 571.8C154.2 577.4 166.5 577.3 176.4 571.4L320 485.3L463.5 571.4C473.4 577.3 485.7 577.5 495.7 571.8C505.7 566.1 512 555.5 512 544L512 128C512 92.7 483.3 64 448 64L192 64z" /></svg>
