...
import { ThemeSubmenu, FontSubmenu, HightlightSubmenu } from './SubMenu/submenu';
...
export const ContextMenu = ({ }) => {
    ...
    const HightlightSubmenuRef = useRef(null)
    ...
    const showTooltip = useCallback((e) => {
        ...
        if (hasSelection && selection.rangeCount > 0) {
            ...
            textOptionsRef.current.classList.remove('hidden');
        } else {
            appState.currentSelection = '';
            appState.selectionRange = null;
            textOptionsRef.current.classList.add('hidden');
        }
        ...
        <div
            ...
            <div className="context-menu-options">
                ...
                <div id="generalOptions" className="font-mono tracking-tighter">
                    ...
                    <NoteOption autohide={autohidesubmenu} />
                    <DictionaryOption autohide={autohidesubmenu} />
...
const TextSelectionMenu = ({ selectionoptionsRef, autohide }) => {
    return (
        <>
            ...
            <div
                ...
                <HignlightOption autohide={autohide} />
                <div className="border-t border-gray-700 my-1"></div>
...
const HignlightOption = ({ autohide }) => {
    const submenuref = useRef(null)
