...
export const SearchResultPage = ({ }) => {
    ...
    return (
        <div ref={resultContainer} id="search-result-container" className="fixed inset-0 flex items-center justify-center p-4 backdrop-brightness-50 translate-y-[100vh] z-50 transition-all duration-500">
